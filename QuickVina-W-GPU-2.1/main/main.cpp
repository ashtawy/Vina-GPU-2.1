...
int main(int argc, char* argv[]) {
	...
	const std::string version_string = "QuickVina-W 2.1";
...
#################################################################\n\
# If you used QuickVina-W-GPU 2.1 in your work, please cite     #\n\
#                                                               #\n\
...
#################################################################\n";
	...
	if (file.is_open())
	{
		file << "QuickVina-W-GPU3 total runtime = " << (double)(end - start) / CLOCKS_PER_SEC << " s" << std::endl;
		file.close();
	}
#endif

	std::cout << "QuickVina-W-GPU3 total runtime = " << (double)(end - start) / CLOCKS_PER_SEC << " s" << std::endl;
	//getchar();
}
